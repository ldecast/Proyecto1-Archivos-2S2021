...
int CortarYPegar(string _path_cut, string _name_cut, string _path_paste, string _name_paste)
{
...
int mv(string _path, string _dest)
{
    if (_path == "" || _dest == "")
    ...
    return CortarYPegar(npath1, name1, npath2, name2);
}
